...
\begin{itemize}
    \item \textbf{RQ1:} How can a Knowledge Graph be modeled to effectively integrate diverse types of legacy test artifacts, specifically structured requirements and unstructured descriptions, for semantic retrieval?

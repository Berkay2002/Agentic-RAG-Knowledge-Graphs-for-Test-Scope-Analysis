...
\midrule
Agent Orchestration (\S\ref{sec:ai-agents}) & LangGraph & Manages agent state machine and tool execution flow \\
...
The system architecture follows a layered design, separating data storage, retrieval mechanisms, and agentic control logic (see Figure~\ref{fig:system-layers}).
